...
def setUsername(username):
    username_label.config(text=f'Hey! {username}')
...
# Label widget
username_label = Label(f1, text='', font=f)  # Create a label to display the username
username_label.grid(row=0, column=0, columnspan=4)  # Add the label above the Treeview
